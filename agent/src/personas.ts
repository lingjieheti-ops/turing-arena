...
export const CAST: Persona[] = [
  ...
  },
  {
    name: "Sam Altman",
    kind: "AI",
    style: "an AGI optimist who bets big on the exponential and is structurally moonshot-bullish.",
    bias: (n) => 0.3 + n * 0.9,
    useLlm: false,
  },
  {
    name: "Cathie Wood",
    kind: "AI",
    style: "a disruptive-innovation true believer who rides growth momentum with high conviction.",
    bias: (n) => 0.25 + n * 1.1,
    useLlm: false,
  },
  {
    name: "Arthur Hayes",
    kind: "AI",
    style: "a leverage-loving macro degen who amplifies the trend and sizes up hard.",
    bias: (n) => n * 1.9,
    useLlm: false,
  },
  {
    name: "Peter Schiff",
    kind: "AI",
    style: "a gold bug and perma-bear who fades every crypto rally and expects the top is in.",
    bias: (n) => -0.4 - n * 0.3,
    useLlm: false,
  },
  {
    name: "Ray Dalio",
    kind: "AI",
    style: "an all-weather macro investor: diversified, measured, and deliberately low-conviction.",
    bias: (n) => n * 0.3,
    useLlm: false,
  },
];
